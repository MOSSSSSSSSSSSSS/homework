...
int main()
{
    ...
    std::cout << "本段文本已经保存在文本文件“" << fileName << "”中。";
    ...
    // 展示文件内容
    std::cout << std::endl << "显示源文件“" << fileName << "”：" << std::endl;
    fp = fopen(fileName, "r");
    ...
    // 利用Trie得到关键词词频
    std::cout << std::endl << "在源文件中共检索到 ：" << trie.search(_keyWord) << "个关键字“" << keyWord << "”" << std::endl;
    system("pause");
    return 0;
