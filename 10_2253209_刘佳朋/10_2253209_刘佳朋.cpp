...
void HeapSort(int a[], int begin, int end)
{
	...
	{
		std::swap(a[begin], a[begin + j]);// 将堆顶元素与末尾元素进行交换
...
int main()
{
	...
	std::cout << std::endl << "请输入产生随机数的个数(1-10000)：";
	...
	std::cout << "冒泡排序比较次数: " << cnt << std::endl << std::endl;
	cnt = 0;
	...
	end_time = clock();
	std::cout << "The run time is: " << double(end_time - start_time) / CLOCKS_PER_SEC << "s" << std::endl;
	std::cout << "选择排序比较次数: " << cnt << std::endl << std::endl;
	cnt = 0;
	...
	end_time = clock();
	std::cout << "The run time is: " << double(end_time - start_time) / CLOCKS_PER_SEC << "s" << std::endl;
	std::cout << "插入排序比较次数: " << cnt << std::endl << std::endl;
	cnt = 0;
	...
	end_time = clock();
	std::cout << "The run time is: " << double(end_time - start_time) / CLOCKS_PER_SEC << "s" << std::endl;
	std::cout << "希尔排序比较次数: " << cnt << std::endl << std::endl;
	cnt = 0;
	...
	end_time = clock();
	std::cout << "The run time is: " << double(end_time - start_time) / CLOCKS_PER_SEC << "s" << std::endl;
	std::cout << "快速排序比较次数: " << cnt << std::endl << std::endl;
	cnt = 0;
	...
	end_time = clock();
	std::cout << "The run time is: " << double(end_time - start_time) / CLOCKS_PER_SEC << "s" << std::endl;
	std::cout << "堆排序比较次数: " << cnt << std::endl << std::endl;
	cnt = 0;
	...
	end_time = clock();
	std::cout << "The run time is: " << double(end_time - start_time) / CLOCKS_PER_SEC << "s" << std::endl;
	std::cout << "归并排序比较次数: " << cnt << std::endl << std::endl;
	cnt = 0;
	...
	end_time = clock();
	std::cout << "The run time is: " << double(end_time - start_time) / CLOCKS_PER_SEC << "s" << std::endl;
	std::cout << "基数排序比较次数: " << cnt << std::endl << std::endl;
	cnt = 0;
